...
describe("Drop CloudPattern: 'aws-account-in-partition'", () => {
    ...
    it("provide requested property value to cloud pattern", async () => {
    ...
    it("provide drop requested property value to cloud pattern", async () => {
        ...
        console.log("Set properties response: ", setPropertiesResponse);
        if (setPropertiesResponse !== null) {
